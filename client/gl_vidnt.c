...
void CheckMultiTextureExtensions(void) 
{
	if (!COM_CheckParm("-nomtex")) {
		...
		qglMTexCoord2f = (void *) wglGetProcAddress("glMultiTexCoord2f");
		qglActiveTexture = (void *) wglGetProcAddress("glActiveTexture");
		gl_mtexable = true;
	}
}
#else
